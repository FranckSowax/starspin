    ...
    <div className="min-h-screen bg-[#E8EDE8]">
      ...
      <header className="fixed top-0 w-full bg-[#1B4332]/95 backdrop-blur-sm z-50">
        <div className="container mx-auto px-4 sm:px-6 py-2 sm:py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#demo" className="!text-white hover:!text-[#FFD700] transition-colors duration-300 text-sm font-medium px-2 py-1">{t('landing.nav.howItWorks')}</a>
            <a href="#pricing" className="!text-white hover:!text-[#FFD700] transition-colors duration-300 text-sm font-medium px-2 py-1">{t('landing.nav.pricing')}</a>
            <a href="#testimonials" className="!text-white hover:!text-[#FFD700] transition-colors duration-300 text-sm font-medium px-2 py-1">{t('landing.nav.testimonials')}</a>
          </nav>
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-8 sm:pb-12 relative z-10">
          <div className="grid md:grid-cols-3 gap-8 sm:gap-12 items-center min-h-[calc(100vh-8rem)] sm:min-h-[calc(100vh-10rem)] md:min-h-[calc(100vh-12rem)]">
      ...
      <section id="demo" className="py-24 px-4 bg-gradient-to-br from-slate-50 to-white scroll-mt-20 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          <StaggeredReveal
            ...
            staggerDelay={150}
          >
            <div className="text-center p-6 bg-white rounded-xl shadow-xl border border-2 border-gray-100 hover:shadow-lg hover:border-[#52B788]/30 transition-all duration-300 group">
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="bg-white border border-red-100 shadow-xl hover:shadow-2xl transition-all p-6 rounded-3xl">
              ...
              <Card className="bg-white border-2 border-gray-200 shadow-xl hover:shadow-2xl transition-all p-6 rounded-3xl">
                <div className="flex items-center gap-6 mb-4">
              ...
              {/* Impact card - Compact */}
              <Card className="bg-[#2D6A4F] border-0 shadow-lg p-6 rounded-3xl text-white relative overflow-hidden">
      ...
      <section className="py-24 px-4 bg-gray-50">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {/* Step 1 */}
            <Card 
              className="group bg-white border-2 border-gray-200 rounded-3xl p-8 hover:border-[#2D6A4F] hover:shadow-xl transition-all duration-300"
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 bg-[#2D6A4F] rounded-3xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 bg-[#2D6A4F] rounded-3xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all">
                  <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-16 text-center">
            <Card className="max-w-3xl mx-auto bg-gradient-to-br from-[#2D6A4F] to-[#1B4332] border-0 rounded-3xl p-10">
      ...
      <section className="py-24 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="group bg-white border-2 border-gray-200 rounded-3xl p-8 hover:border-amber-500 hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-500 rounded-3xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-16 max-w-6xl mx-auto">
            <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200/50 rounded-3xl p-8 md:p-12">
              <div className="grid md:grid-cols-3 gap-8 items-center">
                {/* Column 1 - QR Code Screen */}
                <div className="relative rounded-3xl overflow-hidden shadow-xl transform hover:scale-105 transition-transform">
                  <Image
      ...
      <section className="py-24 px-4 bg-gray-50">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            ...
            <Card className="group bg-white border-2 border-gray-200 rounded-3xl p-8 hover:border-[#2D6A4F] hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 bg-[#2D6A4F] rounded-3xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-16 max-w-5xl mx-auto">
            <Card className="bg-gradient-to-br from-[#2D6A4F] to-[#1B4332] border-0 rounded-3xl p-10">
      ...
      <section id="testimonials" className="py-24 px-4 bg-gray-50">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Testimonial 1 */}
            <Card className="bg-white border-2 border-gray-200 rounded-3xl p-8 hover:shadow-xl transition-shadow">
      ...
      <section id="pricing" className="py-24 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Starter Plan */}
            <Card className="bg-white border-2 border-gray-200 rounded-3xl p-8 hover:shadow-xl transition-all">
            ...
            {/* Pro Plan - Featured */}
            <Card className="bg-gradient-to-br from-[#2D6A4F] to-[#1B4332] border-0 rounded-3xl p-8 shadow-2xl relative transform md:scale-105">
          ...
          <div className="mt-16 text-center">
            <Card className="max-w-3xl mx-auto bg-gray-50 border-2 border-gray-200 rounded-3xl p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <Card key={index} className="bg-white border-2 border-gray-200 rounded-3xl overflow-hidden hover:shadow-lg transition-shadow">
                  <button
            ...
            {/* Contact Card */}
            <Card className="bg-white border-2 border-gray-200 rounded-3xl p-8 h-fit">
